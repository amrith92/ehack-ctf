...
Tproto.Clicked = function(e) {
  /*var a = this, t = a.target, h = a.href, evt;
  if(t != '' && t != '_self') {
    if(self.frames[t]) {
 ...
 * @constructor
 */
function TagCanvas(cid,lctr,opt,select) {
...
TCproto.GetTags = function() {
  ...
  for(i = 0; i < el.length; ++i) {
    etl = el[i].getElementsByTagName('option');
...
TagCanvas.Start = function(id,l,o,s) {
  TagCanvas.tc[id] = new TagCanvas(id,l,o,s);
};
...
jQuery.fn.tagcanvas = function(options, lctr, select) {
  var fn = {
    pause: function() {
      $(this).each(function() {
  ...
  if(typeof(options) == 'string' && fn[options]) {
    ...
    TagCanvas.jquery = 1;
    $(this).each(function() {
      TagCanvas.Start($(this)[0].id, lctr, options, $('#' + select));
    });
